...
DATA_CAPTION_DIR = '/fsx/yban/kubric/generated_dataset/reverse_time_complex/metadata.csv'
RATIO = 0.9
...
with open('/fsx/yban/kubric/generated_dataset/reverse_time_complex/train.json', 'w') as f:
    json.dump(training_captions_dict, f)

with open('/fsx/yban/kubric/generated_dataset/reverse_time_complex/val.json', 'w') as f:
