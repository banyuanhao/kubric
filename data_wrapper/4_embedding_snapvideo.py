...
DATA_CAPTION_DIR = 'generated_dataset/reverse_time_video_and_image/metadata_video_two_direction.csv'
...
if __name__ == "__main__":
    ...
    for i, filename in enumerate(path):
        ...
        if '.pkl' not in output_filename:
            raise ValueError(f"output_filename {output_filename} does not contain .pkl")
