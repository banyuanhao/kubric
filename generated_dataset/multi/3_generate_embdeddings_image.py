...
DATA_CAPTION_DIR = 'generated_dataset/multi/metadata_aug_splited.csv'
...
if __name__ == "__main__":
    ...
    summary_text = df.text_image.tolist()
    ...
    for i, filename in enumerate(path):
        ...
        output_filename = filename.replace(".mp4", "_embeddings_image.pkl")
