...
if __name__ == "__main__":
    ...
    print(data.head())
    select_data_image = data[(data['usage'] == 'train_image') |  (data['usage'] == 'val_image')|(data['usage_bal'] == 'train_image') |  (data['usage_bal'] == 'val_image') ]
    print(f"Number of videos: {len(select_data_image)}")
    

    # We will go over all videos
    image_paths = select_data_image.image_path.tolist()
    caps = select_data_image.text_image.tolist()
