...
DATA_CAPTION_DIR = 'generated_dataset/multi_obj/metadata_splited.csv'



DATA_DIR = '/fsx/yban/dataset/multi_obj'
...
def process_video(video_path):
    ...
    """
    vidinfo = {}
    video_name = 'image_' + os.path.basename(os.path.dirname(video_path))
...
if __name__ == "__main__":
    ...
    print(data.head())
    select_data_image = data[(data['usage'] == 'train_image') |  (data['usage'] == 'val_image') | (data['usage_bal'] == 'train_image')]
