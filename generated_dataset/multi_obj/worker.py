...
parser.add_argument("--min_num_dynamic_objects", type=int, default=2,
                    help="minimum number of dynamic (tossed) objects")
parser.add_argument("--max_num_dynamic_objects", type=int, default=2,
...
# --- Populate the scene
# background HDRI
with open('generated_dataset/multi_obj/backgrounds.json') as f:
...
# ---- Object placement ----
with open('generated_dataset/multi_obj/split_sets.json') as f:
