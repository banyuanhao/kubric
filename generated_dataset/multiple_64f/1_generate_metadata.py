...
def process_metadata(metadata_name):
    ...
    # random select 8 int froom 0 to 64 
    selected_integers = random.sample(range(0, 64), 8)
    image_path = [os.path.join(METADATA_PATH, f'{id}/rgba_{image_selecting:05d}.png') for image_selecting in selected_integers]
    ...
    return {
        ...
        'image_selecting': selected_integers,
        'usage': 'tbc',
    }
