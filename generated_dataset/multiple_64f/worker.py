...
# parser.add_argument("--step_rate", type=int, default=120)
parser.add_argument("--ii", required=True, type=int)
parser.set_defaults(save_state=False, frame_end=64, frame_rate=12,
                    resolution=128, step_rate=120)
...
# --- Populate the scene
# background HDRI
with open('generated_dataset/multiple/backgrounds.json') as f:
...
# ---- Object placement ----
with open('generated_dataset/multiple/split_sets.json') as f:
...
if rand_rng < 0.25:
    ...
    split_name = 'both'
active_split = split_sets[split_name]
